...
public class BooleanQueryExample {
	 ...
	 * BooleanClause.Occur.SHOULD  可能包含
	...
	public void booleanQuery() throws IOException {
		...
		query.add(new BooleanClause(new TermQuery(new Term("content", "humpty")), BooleanClause.Occur.MUST));
		query.add(new BooleanClause(new TermQuery(new Term("content", "dumpty")), BooleanClause.Occur.MUST));
		query.add(new BooleanClause(new TermQuery(new Term("content", "wall")), BooleanClause.Occur.SHOULD));
		query.add(new BooleanClause(new TermQuery(new Term("content", "sat")), BooleanClause.Occur.MUST_NOT));
	...
	public static void main(String args[]) throws IOException {
		BooleanQueryExample ex = new BooleanQueryExample();
		ex.addDocument();
		ex.booleanQuery();
	}
}
